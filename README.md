...
> **Interactive map (HTML):** [`docs/figures/exposure_map.html`](docs/figures/exposure_map.html)
> — open locally in a browser; GitHub does not render HTML inline.
> Layers: assets coloured by rank (popup with class, rank, top-3 features),
> fuel-class overlay, ICNF burn perimeters.
